if (room == rm_controls) {
	...
	var getItens = "Pegar itens: Botao direito do mouse, itens pegaveis brilham vermelho quando em range";
	var throwItems = "Jogar itens: Botao esquerdo do mouse, segure para jogar mais lonje";
